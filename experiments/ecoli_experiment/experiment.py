...
pdb_id_file = "pdb_ecoli.id_list"
ppi_db_file = "pdb_ecoli.ppi.sqlite"
train_uid_file = "ecoli_train.uid"
test_uid_file_discard = "ecoli_test.uid"
test_uid_file = "ecoli_silver_nooverlap.csv"
train_csv_file = "ecoli_train.csv"
test_csv_file = "ecoli_test.csv"
ppi_train_file = "ppi_ecoli_pos_neg_train.pkl"
ppi_train_interactions_file = "ppi_ecoli_interactions_train.pkl"
segment_classifier_file = "levelI_clf.zip"
ppi_matrices_train_file = "ppi_ecoli_xy_train.pkl"
...
psipred_secstr_file = "uid2secstr_ecoli_silver.csv"
...
def create_segment_datasets(input_file, output_files):
    segment_datasets.create_data_table(input_file, train_uid_file, test_uid_file_discard,
            train_csv_file, test_csv_file, segment_feature_encoder,
            interaction_threshold, True, 0.99)
